...
- **Locked policy:** `docs/AQUACULTURE_ACCOUNTING_POLICY.md` — Model A nursing (profit centre + margin/kg; surplus accepted), bio-cap on 1581 (never invent inventory), dual biomass truth (15/25% bands), cost model on 1581. Helpers: `api.services.aquaculture_accounting_policy`.
