...
INDUSTRY_BENCHMARKS: dict[str, dict[str, Any]] = {
    ...
    "pond_density_kg_per_decimal": {
        ...
        "high_above": 55,
        "critical_above": 55,
        "note_bn": "সেমি-ইনটেনসিভ গ্রো-আউট: ~15–40 kg/dec স্বাচ্ছন্দ্য; ≥55 চাপ। pcs/dec ~150–230 স্বাচ্ছন্দ্য।",
        "source": "BD DoF / WorldFish-style grow-out practice (kg/dec & pcs/dec)",
    },
