...
urlpatterns = [
    ...
    path("admin/brain-config", admin_brain_views.admin_brain_config),
    path("admin/brain-usage/", admin_brain_views.admin_brain_usage_logs),
    path("admin/brain-usage", admin_brain_views.admin_brain_usage_logs),
    path("admin/companies/<int:company_id>/brain-settings/", admin_brain_views.admin_brain_company_settings),
    path("admin/companies/<int:company_id>/brain-settings", admin_brain_views.admin_brain_company_settings),
    ...
    path("brain/transcribe", brain_views.brain_transcribe),
    path("brain/suggested-questions/", brain_views.brain_suggested_questions),
    path("brain/suggested-questions", brain_views.brain_suggested_questions),
    path("brain/insights/", brain_views.brain_insights),
    path("brain/insights", brain_views.brain_insights),
    path("brain/predictions/", brain_views.brain_predictions),
    path("brain/predictions", brain_views.brain_predictions),
    path("brain/settings/", brain_views.brain_company_settings),
    path("brain/settings", brain_views.brain_company_settings),
    path("brain/usage/", brain_views.brain_usage_logs),
    path("brain/usage", brain_views.brain_usage_logs),
    path("brain/insights/<int:insight_id>/dismiss/", brain_views.brain_insight_dismiss),
    path("brain/insights/<int:insight_id>/dismiss", brain_views.brain_insight_dismiss),
    path("brain/documents/", brain_views.brain_documents),
    path("brain/documents", brain_views.brain_documents),
    path("brain/documents/<int:document_id>/", brain_views.brain_document_delete),
    path("brain/documents/<int:document_id>", brain_views.brain_document_delete),
    path("brain/handover/", brain_views.brain_handover_profiles),
    path("brain/handover", brain_views.brain_handover_profiles),
    path("brain/handover/<int:handover_id>/", brain_views.brain_handover_detail),
    path("brain/handover/<int:handover_id>", brain_views.brain_handover_detail),
    ...
    path(
        "vendors/<int:vendor_id>/monthly-scheme/",
        vendor_purchase_views.vendor_apply_monthly_scheme,
    ),
    path(
    ...
    path(
        "vendors/<int:vendor_id>/mill-credit-notes/",
        vendor_purchase_views.vendor_apply_mill_term,
    ),
    ...
    path("credit-notes/", accounting_views.credit_notes_create),
    path("credit-notes/<int:credit_note_id>/refund/", accounting_views.credit_note_refund),
    path("fiscal-years/close/", accounting_views.fiscal_year_close_view),
    path("bank-reconciliations/", accounting_views.bank_reconciliations_create),
    ...
    path(
        "employees/<int:employee_id>/ledger/entries/<int:entry_id>/",
        hr_views.employee_ledger_entry_detail,
    ),
