...
11. [সাধারণ ভুল ও সমাধান](#১১-সাধারণ-ভুল)
...
**Fuel station expense rollup → COA (Adib bills):**
...
### ৯.৬ দ্রুত COA চেকলিস্ট (হিসাবরক্ষী)
...
- [ ] Adib bill **6900** দিয়ে ভরছে না তো? → category / **6920** check
...
- [ ] Inventory valuation reasonable?
...
| Duplicate lease in Pond costs | দ্বিগুণ খরচ | **Landlords** lease paid ব্যবহার |
