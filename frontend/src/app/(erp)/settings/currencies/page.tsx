          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {currencies.map((currency) => (
              <tr key={currency.code} className={currency.is_default ? 'bg-yellow-50' : ''}>
                ...
                <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{currency.name}</td>
                <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{currency.symbol}</td>
                <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{currency.decimal_places}</td>
                <td className="whitespace-nowrap px-6 py-4">
                  <span
