...
export default function PreFormulationsPage() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Pre-Formulation Library</h1>
        <p className="text-gray-600">World Standard Pre-Formulation Templates</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-4">
          ...
          {selectedCategory === 'Fish' && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Pellet (mm)</label>
              <select
          ...
          {selectedCategory === 'Fish' && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Float Type</label>
              <select
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Pellet (mm)</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {isLoading ? (
                ...
                preformulations.map((preform) => (
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{preform.code}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{preform.title}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{preform.category}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{preform.species}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{preform.stage}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{preform.process_type}</td>
                ...
                <tr>
                  <td colSpan={8} className="px-6 py-4 text-center text-gray-500">No pre-formulations found</td>
                </tr>
              )}
            </tbody>
          </table>
