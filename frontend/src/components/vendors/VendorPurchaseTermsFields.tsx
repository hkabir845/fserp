    ...
    <div className="col-span-2 mt-2 rounded-lg border border-amber-200/80 bg-amber-50/50 p-4 space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          {showRateCard
            ? 'Credit limit = buy on account up to the ceiling (or pay cash). Instant % of MRP and transport ৳/ton are taken on the feed bill. Monthly % and yearly % commissions are credited to your mill account only after their official approval.'
            : 'Set the credit ceiling here. Instant discount, transport ৳/ton and scheme commissions are applied when you receive a bill (Apply mill terms) or post a mill credit — not when creating the vendor.'}
        </p>
      </div>
      ...
      {showRateCard ? (
        <div>
          ...
          <p className="text-[11px] text-muted-foreground mb-2">
            Examples: 5.5% instant on MRP; transport credit ৳950 / ton (10 t → ৳9,500); 3% monthly and
            2.5% yearly commissions credited to your mill account after their official approval. Leave
            unused fields at 0. Override per bill with <span className="font-medium text-foreground">Mill terms</span>.
          </p>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2 sm:col-span-1">
              <label className="mb-1 block text-xs font-medium">Transport credit Tk / ton</label>
              <input
                type="number"
                min={0}
                step="0.01"
              ...
              />
              <p className="text-[11px] text-muted-foreground mt-0.5">
                Primary mill transport: ordered tons × this rate (10 t × 950 = 9,500). Needs item sack kg
                or qty in kg.
              </p>
            </div>
            <div>
              <label className="mb-1 block text-xs font-medium">Transport % of MRP (optional)</label>
              <input
                type="number"
                min={0}
                step="0.01"
            ...
            <div>
              <label className="mb-1 block text-xs font-medium">Fixed Tk / bill (optional)</label>
              <input
                type="number"
                min={0}
                step="0.01"
                ...
                className="erp-field"
                placeholder="Rare — prefer per ton"
              />
            </div>
            <div>
            ...
            <div>
              ...
              />
              <p className="text-[11px] text-muted-foreground mt-0.5">
                Tracked automatically. Credited to your mill A/P only after their official approval
                (Post monthly scheme).
              </p>
            </div>
            <div>
              ...
              />
              <p className="text-[11px] text-muted-foreground mt-0.5">
                Same — posts after mill approval when the tonnage target is met.
              </p>
            </div>
            <div className="col-span-2 sm:col-span-1">
