...
const strings: Dict = {
  ...
  fromFishPurchase: { en: 'From fish purchase', bn: 'মাছ কেনা থেকে' },
  fromTransferIn: { en: 'Transfer in (bought)', bn: 'স্থানান্তর গ্রহণ (কেনা)' },
  fromTransferOut: { en: 'Transfer out (sold)', bn: 'স্থানান্তর প্রদান (বিক্রি)' },
  sampleTimeLabel: { en: 'Time (optional)', bn: 'সময় (ঐচ্ছিক)' },
  autoSampleEditNote: {
    en: 'This row was created automatically from a fish movement. Editing it here will be overwritten the next time that bill or transfer is saved.',
    bn: 'এই সারিটি মাছ চলাচল থেকে স্বয়ংক্রিয়ভাবে তৈরি। এখানে সম্পাদনা করলে সংশ্লিষ্ট বিল বা স্থানান্তর পরের বার সংরক্ষণে তা মুছে যাবে।',
  },
  ...
  soldForCol: { en: 'Sold for', bn: 'বিক্রয় মূল্য' },
  internalSaleDocsHint: {
    en: 'Internal sale paperwork — settled through the inter-pond current account, not in cash.',
    bn: 'অভ্যন্তরীণ বিক্রয়ের নথি — নগদে নয়, আন্তঃপুকুর চলতি হিসাবের মাধ্যমে নিষ্পত্তি।',
  },
  marginEarnedCol: { en: 'Margin earned', bn: 'অর্জিত মার্জিন' },
  ...
  transferHistoryHeading: { en: 'Past transfers', bn: 'পুরনো স্থানান্তর' },
  transferDestination: { en: 'Destination', bn: 'গন্তব্য' },
  transferBookCost: { en: 'Book cost', bn: 'বইয়ের খরচ' },
  transferDocuments: { en: 'Sale documents', bn: 'বিক্রয় নথি' },
  transferInvoice: { en: 'Invoice', bn: 'ইনভয়েস' },
  transferBill: { en: 'Bill', bn: 'বিল' },
  transferGlPosted: { en: 'GL posted', bn: 'GL পোস্ট হয়েছে' },
  transferGlNotPosted: { en: 'GL not posted', bn: 'GL পোস্ট হয়নি' },
  noTransfersYet: {
    en: 'No past transfers in this list. New fish moves are recorded as sales.',
    bn: 'এই তালিকায় কোনো পুরনো স্থানান্তর নেই। নতুন মাছ সরানো এখন বিক্রয় হিসেবে রেকর্ড হয়।',
  },
  goToFishSales: { en: 'Go to fish sales', bn: 'মাছ বিক্রয়ে যান' },
