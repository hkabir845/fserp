...
export const AQUACULTURE_NAV_GROUPS: AquacultureNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/aquaculture/day-log', label: 'Pond day log', sidebarLabel: 'Day log', icon: ClipboardList },
      { href: '/aquaculture/feeding', label: 'Feeding advice', icon: Sparkles },
      { href: '/aquaculture/medicine', label: 'Medicine & treatments', icon: Pill },
      {
        href: '/aquaculture/plan',
        label: 'Harvest & production plan',
        sidebarLabel: 'Harvest plan',
        icon: CalendarRange,
      },
    ],
  },
