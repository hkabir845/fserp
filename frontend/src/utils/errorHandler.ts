...
export function initConsoleErrorFilter(): void {
  ...
  const checkExtensionError = (arg: any): boolean => {
    ...
    if (typeof arg === 'string') {
      ...
      if (/Cannot connect to server|ERR_CONNECTION_REFUSED|ERR_NETWORK|Failed to load resource|Failed to fetch.*localhost:8000|Network Error|Backend server connection error|Please ensure.*server.*running|GET.*localhost:8000.*ERR_CONNECTION_REFUSED|POST.*localhost:8000.*ERR_CONNECTION_REFUSED|PUT.*localhost:8000.*ERR_CONNECTION_REFUSED|DELETE.*localhost:8000.*ERR_CONNECTION_REFUSED|PATCH.*localhost:8000.*ERR_CONNECTION_REFUSED|net::ERR_CONNECTION_REFUSED|GET http:\/\/localhost:8000|POST http:\/\/localhost:8000|PUT http:\/\/localhost:8000|DELETE http:\/\/localhost:8000|PATCH http:\/\/localhost:8000|:\d+\/api\/.*ERR_CONNECTION_REFUSED|:\d+\/api\/.*Failed to load/i.test(arg)) {
        return true
      }
    ...
    if (arg instanceof Error) {
      ...
      if (/Cannot connect to server|ERR_CONNECTION_REFUSED|ERR_NETWORK|Failed to load resource|Failed to fetch.*localhost:8000|Network Error|Backend server connection error|Please ensure.*server.*running|Error fetching.*ERR_NETWORK|AxiosError.*Network Error|GET.*localhost:8000.*ERR_CONNECTION_REFUSED|POST.*localhost:8000.*ERR_CONNECTION_REFUSED|PUT.*localhost:8000.*ERR_CONNECTION_REFUSED|DELETE.*localhost:8000.*ERR_CONNECTION_REFUSED|PATCH.*localhost:8000.*ERR_CONNECTION_REFUSED|net::ERR_CONNECTION_REFUSED|:\d+\/api\/.*ERR_CONNECTION_REFUSED|:\d+\/api\/.*Failed to load/i.test(errorStr)) {
    ...
    if (typeof arg === 'object') {
      ...
      if (/Cannot connect to server|ERR_CONNECTION_REFUSED|ERR_NETWORK|Failed to load resource|Failed to fetch.*localhost:8000|Network Error|Backend server connection error|Please ensure.*server.*running|Error fetching.*ERR_NETWORK|AxiosError.*Network Error|code.*ERR_NETWORK|code.*ERR_CONNECTION_REFUSED|GET.*localhost:8000.*ERR_CONNECTION_REFUSED|POST.*localhost:8000.*ERR_CONNECTION_REFUSED|PUT.*localhost:8000.*ERR_CONNECTION_REFUSED|DELETE.*localhost:8000.*ERR_CONNECTION_REFUSED|PATCH.*localhost:8000.*ERR_CONNECTION_REFUSED|:\d+\/api\/.*ERR_CONNECTION_REFUSED|:\d+\/api\/.*Failed to load/i.test(objStr)) {
        return true // Suppress expected connection errors
      }
    ...
    try {
      ...
      // Filter expected connection errors
      if (/Cannot connect to server|ERR_CONNECTION_REFUSED|ERR_NETWORK|Failed to load resource|Failed to fetch.*localhost:8000|Network Error|Backend server connection error|Please ensure.*server.*running|Error fetching.*ERR_NETWORK|AxiosError.*Network Error|GET.*localhost:8000.*ERR_CONNECTION_REFUSED|POST.*localhost:8000.*ERR_CONNECTION_REFUSED|PUT.*localhost:8000.*ERR_CONNECTION_REFUSED|DELETE.*localhost:8000.*ERR_CONNECTION_REFUSED|PATCH.*localhost:8000.*ERR_CONNECTION_REFUSED|:\d+\/api\/.*ERR_CONNECTION_REFUSED|:\d+\/api\/.*Failed to load/i.test(str)) {
        return true // Suppress expected connection errors
      }
  ...
  window.addEventListener('error', (event) => {
    ...
    if (/ERR_CONNECTION_REFUSED|net::ERR_CONNECTION_REFUSED|Failed to load resource|localhost:8000.*ERR_CONNECTION_REFUSED|GET.*localhost:8000.*ERR_CONNECTION_REFUSED|POST.*localhost:8000.*ERR_CONNECTION_REFUSED|PUT.*localhost:8000.*ERR_CONNECTION_REFUSED|DELETE.*localhost:8000.*ERR_CONNECTION_REFUSED|PATCH.*localhost:8000.*ERR_CONNECTION_REFUSED/i.test(errorStr)) {
      event.preventDefault()
      event.stopPropagation()
      event.stopImmediatePropagation()
      return
  ...
  window.addEventListener('unhandledrejection', (event) => {
    ...
    if (reason && typeof reason === 'object') {
      ...
      if (/ERR_NETWORK|ERR_CONNECTION_REFUSED|ECONNREFUSED|Network Error|Failed to fetch|Failed to load resource|GET.*localhost:8000.*ERR_CONNECTION_REFUSED|POST.*localhost:8000.*ERR_CONNECTION_REFUSED|PUT.*localhost:8000.*ERR_CONNECTION_REFUSED|DELETE.*localhost:8000.*ERR_CONNECTION_REFUSED|PATCH.*localhost:8000.*ERR_CONNECTION_REFUSED|net::ERR_CONNECTION_REFUSED|:\d+\/api\/.*ERR_CONNECTION_REFUSED|:\d+\/api\/.*Failed to load/i.test(errorStr)) {
        event.preventDefault()
        return
      }
    }
